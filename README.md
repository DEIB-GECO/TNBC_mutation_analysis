...
## Overview
This repository contains the code and data for my thesis project. It focuses on exploring mutational profiles in TNBC patients using statistical and machine learning methods. The project aims to identify novel therapeutic targets for TNBC patients and improve personalized approaches.
